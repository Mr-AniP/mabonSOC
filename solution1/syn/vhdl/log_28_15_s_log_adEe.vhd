...
entity log_28_15_s_log_adEe_rom is 
    generic(
             DWIDTH     : integer := 18; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of log_28_15_s_log_adEe_rom is 
...
entity log_28_15_s_log_adEe is
    generic (
...
architecture arch of log_28_15_s_log_adEe is
    component log_28_15_s_log_adEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    log_28_15_s_log_adEe_rom_U :  component log_28_15_s_log_adEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
