...
entity log_28_15_s_log_abkb_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of log_28_15_s_log_abkb_rom is 
...
entity log_28_15_s_log_abkb is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of log_28_15_s_log_abkb is
    component log_28_15_s_log_abkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    log_28_15_s_log_abkb_rom_U :  component log_28_15_s_log_abkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
