...
// ==============================================================
#ifndef __mabonsoc_mac_mulseOg__HH__
#define __mabonsoc_mac_mulseOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mabonsoc_mac_mulseOg) {
    ...
    SC_CTOR(mabonsoc_mac_mulseOg):  simcore_mac_0_U ("simcore_mac_0_U") {
