...
void XMabonsoc_Set_t(XMabonsoc *InstancePtr, u32 Data) {
    ...
    XMabonsoc_WriteReg(InstancePtr->Bus_a_BaseAddress, XMABONSOC_BUS_A_ADDR_T_DATA, Data);
}
...
u32 XMabonsoc_Get_t(XMabonsoc *InstancePtr) {
    ...
    Data = XMabonsoc_ReadReg(InstancePtr->Bus_a_BaseAddress, XMABONSOC_BUS_A_ADDR_T_DATA);
    return Data;
}
